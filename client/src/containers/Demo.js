          ...
          <div className="carousel-item">
            ...
            <div className="carousel-caption-8 py-20">
              <h1 className="caption-8">
                ...
                <br />
                <br />
                <small>About feature:</small>
                <br /> - Carousel Slides that promotes the mentor4me app.
                <br /> - Carousel slides to introduce the app, its
                functionalities, and technologies used.
                <br />
                <br />
                <small>Dev Team Intro feature:</small>
                <br /> - A section in home page to introduce the developer team
                members
              </h1>
            </div>
          </div>
